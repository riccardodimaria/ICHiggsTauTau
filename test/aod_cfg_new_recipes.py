...
#opts.register('file', 'root://xrootd.unl.edu//store/mc/Phys14DR/GluGluToHToTauTau_M-125_13TeV-powheg-pythia6/AODSIM/PU20bx25_tsg_PHYS14_25_V1-v1/00000/1EBAF543-AC6F-E411-B67A-3417EBE2EC98.root', parser.VarParsing.multiplicity.singleton,
...
#opts.register('globalTag', 'START72_V1::All', parser.VarParsing.multiplicity.singleton,
...
#process.mvaNonTrigphys14 = cms.EDFilter("ElectronIdMVAProducerCSA14",
...
process.muonPFIsolationValuesSequence = cms.Sequence(
    ...
    process.muPFIsoValueChargedAll03+
...
#      )
#from RecoJets.JetProducers.PileupJetID_cfi import full_5x_chs
...
process.icPFJetProducer = producers.icPFJetProducer.clone(
  ...
  #    inputPileupID         = cms.InputTag("puJetMva","full"),
...
process.icPFJetProducer.input = cms.InputTag("selectedPFJetsAK4")
process.icPFJetProducer.srcConfig.applyJECs = cms.bool(True)
...
if release in ['70XMINIAOD', '72XMINIAOD']:
  process.icPFJetProducer.destConfig.includeJetID = cms.bool(True)
  #process.icPFJetProducerAK4.destConfig.includePileupID = cms.bool(True)
  #process.icPFJetProducerAK4.destConfig.inputPileupID = cms.InputTag("puJetMva", "full")
  process.icPFJetProducerAK4.destConfig.includeTrackBasedVars = cms.bool(False)
...
if release in ['70XMINIAOD', '72XMINIAOD', '72X']:
