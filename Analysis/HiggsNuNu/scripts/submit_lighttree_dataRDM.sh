...
for SYST in central
  ...
  JOBDIRPREFIX=/vols/cms/magnan/Hinvisible/RunIILT/jobs_lighttree_170209_oldJEC
  ...
  OUTPUTPREFIX=/vols/cms/magnan/Hinvisible/RunIILT/output_lighttree_170209_oldJEC
  ...
  for QUEUEDIR in medium
    ...
    for FILELIST in `ls filelists/$PRODUCTION/$QUEUEDIR/${PRODUCTION}_DATA_2016E*`
      do
