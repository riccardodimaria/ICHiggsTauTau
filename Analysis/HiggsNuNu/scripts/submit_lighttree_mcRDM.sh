...
#for SYST in UESUP UESDOWN ELEEFFUP ELEEFFDOWN MUEFFUP #MUEFFDOWN #NOTE TO RUN JER DOSMEAR MUST BE SET TO TRUE IN THE CONFIG
for SYST in MUEFFDOWN #NOTE TO RUN JER DOSMEAR MUST BE SET TO TRUE IN THE CONFIG
...
#for SYST in MUEFFUP MUEFFDOWN
  ...
  JOBDIRPREFIX=/vols/cms/rd1715/HiggsToInv/jobs_lighttree_170210_ReReco
  ...
  OUTPUTPREFIX=/vols/cms/rd1715/HiggsToInv/output_lighttree_170210_ReReco
