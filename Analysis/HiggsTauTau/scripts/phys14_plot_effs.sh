...
# root -l -b -q 'macros/plotDMTable.C("output/phys14/Dec7/MC_53X_VBF_HToTauTau_M-125.root", "phys14/th_mode_table",                 "53X_th_mode_table", "VBF H(125 GeV)#rightarrow#tau#tau  #color[2]{53X}")'
FILE72X="DYJetsToLL_M-50_from_raw.root"
LABEL="74X Default"
# FILE53X="output/phys14/Feb11/MC_53X_VBF_HToTauTau_M-125.root"
root -l -b -q 'macros/plotPFMatch.C+("'${FILE72X}'", "phys14/th_pf_match_pt", "th_pf_match_pt_74X", "all modes", "Track p_{T} (GeV)")'
root -l -b -q 'macros/plotPFMatch.C+("'${FILE72X}'", "phys14/th_pf_match_eta", "th_pf_match_eta_74X", "all modes", "Track #eta")'
root -l -b -q 'macros/plotPFMatch.C+("'${FILE72X}'", "phys14/th0_pf_match_pt", "th0_pf_match_pt_74X", "#pi", "Track p_{T} (GeV)")'
root -l -b -q 'macros/plotPFMatch.C+("'${FILE72X}'", "phys14/th0_pf_match_eta", "th0_pf_match_eta_74X", "#pi", "Track #eta")'
root -l -b -q 'macros/plotPFMatch.C+("'${FILE72X}'", "phys14/th1_pf_match_pt", "th1_pf_match_pt_74X", "#pi#pi^{0}s", "Track p_{T} (GeV)")'
root -l -b -q 'macros/plotPFMatch.C+("'${FILE72X}'", "phys14/th1_pf_match_eta", "th1_pf_match_eta_74X", "#pi#pi^{0}s", "Track #eta")'
root -l -b -q 'macros/plotPFMatch.C+("'${FILE72X}'", "phys14/th10_pf_match_pt", "th10_pf_match_pt_74X", "#pi#pi#pi", "Track p_{T} (GeV)")'
root -l -b -q 'macros/plotPFMatch.C+("'${FILE72X}'", "phys14/th10_pf_match_eta", "th10_pf_match_eta_74X", "#pi#pi#pi", "Track #eta")'
...
#root -l -b -q 'macros/plotTrackTable.C+("'${FILE72X}'", "phys14/trk_plots_unmatched/nmiss_vs_algo", "74X_unmatched_track_table_nmiss", "74X, Non-matched #tau_{h} tracks", "numberOfHits(MISSING_INNER_HITS)")'
...
root -l -b -q 'macros/plotTrackTable.C+("'${FILE72X}'", "phys14/trk_plots_ph_matched/nmiss_vs_algo", "74X_ph_matched_track_table_nmiss", "74X, PFGamma-matched #tau_{h} tracks", "numberOfHits(MISSING_INNER_HITS)")'
